    ...
    <div class="panel">
        ...
        <div class="panel-body no-padding">
            <table class="table table-hover">
                ...
                <form class="form-horizontal" id="projectsForm" role="form" method="post" action="{{url('/teacher/createProject/adoptProjectsSchool')}}">
                    {{csrf_field()}}
                <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{url('/teacher/createProject/checkProjectDetailSchool', $project->project_id)}}"><span class="label label-primary">审查</span></a>
                    </td>
        ...
        <div class="panel-footer">
            <div class="col-md-2">
                <form class="form-inline" id="pageNumForm" role="form" method="get" action="{{url('/teacher/createProject/checkProjectSchool')}}">
                    {{csrf_field()}}
