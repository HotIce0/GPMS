...
@section('content')
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" role="form" method="post" action="{{url('/teacher/createProject/rejectProjectSchool')}}">
                {{csrf_field()}}
                ...
                <div class="form-group {{$errors->has('amendment') ?  'has-error' : ''}}">
                    <label for="amendment" class="col-sm-2 control-label"><a class="text-danger">*</a>修改意见</label>
                    <div class="col-sm-8">
