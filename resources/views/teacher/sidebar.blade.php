    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav">
                ...
                {{--出题模块--}}
                <li>
                    <a href="#createProject" data-toggle="collapse" class="collapsed {{substr_count(url()->current(), 'createProject') > 0 ? 'active' : ''}}"><i class="lnr lnr-file-empty"></i> <span>出题、选题</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
