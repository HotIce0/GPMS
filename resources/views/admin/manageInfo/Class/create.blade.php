        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" method="post" action="">
                ...
                <div class="form-group {{$errors->has('class_identifier') ?  'has-error' : ''}}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="class_identifier" name="ClassInfo[class_identifier]" placeholder="请输入长度为四位的有效数字的班级编号 [ 格式如：1607]"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" id="college_info_id" name="ClassInfo[college_info_id]">
                            {{--@foreach($classInfos['college_info_id'] as $item)--}}
