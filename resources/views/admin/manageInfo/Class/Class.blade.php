...
@section('content')
    ...
    @if(Session::has('failureMsg'))
        <div class="alert alert-danger alert-dismissible" role="alert">
            ...
            @endif <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{--班级编号--}}
                        <th class="edit" id="" >{{ $classInfo->class_identifier}}</th>
                        {{--班级名称--}}
                        <th class="edit" >{{ $classInfo->class_name}}</th>
                        {{--所属学院--}}
